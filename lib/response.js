...
var assert = function(assertion, response) {
  ...
  if (util.isObject(assertion.equal)) {
    util.each(assertion.equal || {}, function(expectedValue, key) {
  ...
  } else if (assertion.equal && !util.equalValues(selectValue, assertion.equal)) {
